...
function TransportListing({ resultsModal, setResultsModal, finalDatesDetail, finalTimesDetail, finalPickup, finalDestination, finalPassengers, finalCarType }) {
    let startY = 0;
                    ...
                    <View style={styles.modalHeader}>
                        ...
                        <View style={{ flexDirection: 'column', marginLeft: 10 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={[{ marginBottom: 1, fontSize: 20, color: commonStylesSheet.modalsText, fontWeight: 'bold' }]}>Back</Text>
                            </View>
                        </View>
                    </View>
                        ...
                        <View>
                            {(loadingTransportsToBook || applyingFilters) ?
                                ...
                                <FlatList
                                    ...
                                    contentContainerStyle={{ paddingBottom: 220, backgroundColor: commonStylesSheet.screenBackground }}
